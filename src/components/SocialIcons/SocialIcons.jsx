...
export default function SocialIcons({ size = 'md', className = '' }) {
  ...
  return (
    <ul className={`${styles.list} ${styles[size]} ${className}`} aria-label="Redes sociais">
      {links.map(([platform, url]) => (
        <li key={platform}>
          <a
            ...
            aria-label={`${artist.name} no ${platform}`}
